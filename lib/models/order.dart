...
class Order extends Equatable {
  ...
  factory Order.fromJson(Map<String, dynamic> json) {
    ...
    try {
      final order = Order(
        ...
        restaurantId: safeStringRequired(json['restaurant_id'],
            fieldName: 'restaurant_id'),
        customerId:
            safeStringRequired(json['customer_id'], fieldName: 'customer_id'),
        deliveryPersonId: safeString(json['delivery_person_id']),
        orderNumber:
            safeStringRequired(json['order_number'], fieldName: 'order_number'),
        status: _parseOrderStatus(json['status']),
        paymentStatus: _parsePaymentStatus(json['payment_status']),
        subtotal: safeDoubleRequired(json['subtotal'], fieldName: 'subtotal'),
        deliveryFee:
            safeDoubleRequired(json['delivery_fee'], fieldName: 'delivery_fee'),
        taxAmount:
            safeDoubleRequired(json['tax_amount'], fieldName: 'tax_amount'),
        serviceFee:
            safeDoubleRequired(json['service_fee'], fieldName: 'service_fee'),
        discountAmount: safeDoubleRequired(json['discount_amount'],
            fieldName: 'discount_amount'),
        totalAmount:
            safeDoubleRequired(json['total_amount'], fieldName: 'total_amount'),
        paymentMethod:
            safeString(json['payment_method'], defaultValue: 'cash') ?? 'cash',
        deliveryAddress:
            json['delivery_address'] != null && json['delivery_address'] is Map
        ...
        estimatedDeliveryTime: safeUtc(json['estimated_delivery_time']),
        actualDeliveryTime: safeUtc(json['actual_delivery_time']),
        appliedPromoCodeId: safeString(json['applied_promo_code_id']),
        appliedPromoCode: safeString(json['applied_promo_code']),
        ...
        restaurant: json['restaurants'] != null && json['restaurants'] is Map
            ? Restaurant.fromJson(
                Map<String, dynamic>.from(json['restaurants']))
            : json['restaurant'] != null && json['restaurant'] is Map
                ? Restaurant.fromJson(
                    Map<String, dynamic>.from(json['restaurant']))
                : null,
        customer: json['user_profiles'] != null && json['user_profiles'] is Map
            ? app_user.User.fromJson(
                Map<String, dynamic>.from(json['user_profiles']))
            : null,
        deliveryPerson: json['delivery_personnel'] != null &&
                json['delivery_personnel'] is Map &&
                json['delivery_personnel']['user'] != null &&
                json['delivery_personnel']['user'] is Map
            ? app_user.User.fromJson(
                Map<String, dynamic>.from(json['delivery_personnel']['user']))
            : null,
        orderItems: safeList<OrderItem>(
          json['order_items'],
          converter: (item) => OrderItem.fromJson(safeMap(item)),
        ),
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'actual_delivery_time': actualDeliveryTime?.toUtc().toIso8601String(),
  ...
  Order copyWith({
    ...
    return Order(
      ...
      orderItems:
          orderItems != null ? List.unmodifiable(orderItems) : this.orderItems,
